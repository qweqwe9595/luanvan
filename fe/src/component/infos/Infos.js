  ...
  return (
    <div className="info">
      ...
      <div className="info_tag">
        ...
        <p>Ngày sinh </p>
        <span>{userInfo.dateOfBirth ? (new Date(userInfo.dateOfBirth)).toLocaleDateString("en-US"): ""}</span>
      </div>
      <div className="info_tag">
      ...
      <div className="info_tag">
        ...
        <p>Ngành </p>
        <span> {userInfo.major ? userInfo.major.majorName : ""} K{userInfo.major ? userInfo.major.yearKey : "" }</span>
      </div>
      <div className="info_tag">
