    ...
    <Modal isOpen={modalIsOpen} ariaHideApp={false} style={{
            ...
            content: {
              ...
              <p>Tạo bài viết mới</p>
                <form>
                  <textarea placeholder="Viết gì đó..." className="share-modal-post-desc" value={desc} onChange={(e) => {setDesc(e.target.value); }}></textarea>
                  <div>
                  <button className="share-modal-post-btn1" onClick={setModalIsOpenToFalse}>HỦY</button>
                  
                  <button className="share-modal-post-btn2" onClick={() => {Post();}}>ĐĂNG</button>
                  </div>
                </form>
            </div> 
    </Modal>
