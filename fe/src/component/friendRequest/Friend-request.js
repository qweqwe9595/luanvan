    ...
    return (
        <div className="friend_request">
            ...
            <div className="friends_request_tag">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2O0zb-Xpon0-VQfC_5QSnKzDObObyD2Tc0Q&usqp=CAU" className="avt_friend_request"></img>
                <div className="friend_request_tag_info">
                    <p style={{ 'textAlign': 'center' }}><b>nguyễn trung toàn</b></p>
